...
@NamedQueries({		
	...
	@NamedQuery(name="Paciente.findByName", query="SELECT obj FROM Paciente obj WHERE obj.nome = :nome" )
...
public class Paciente extends Pessoa {
	...
	//TODO trocar nomePai nomeMae por apenas 'Nomeresponsavel"
