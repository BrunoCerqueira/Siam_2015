...
@MessageDriven(name="clienteHomeBroker.ConsumidorHomeBrokerGoogleMDB",activationConfig=
{
	    ...
	    @ActivationConfigProperty(propertyName="messageSelector",propertyValue="Google = TRUE")
	    


}
		)
public class ConsumidorHomeBrokerGoogleMDB implements MessageListener{
	...
	public void onMessage(Message mensagem) {
			...
			try {
				...
				ConsumidorHomeBrokerGoogleMDB asyncReceiver = new ConsumidorHomeBrokerGoogleMDB();
