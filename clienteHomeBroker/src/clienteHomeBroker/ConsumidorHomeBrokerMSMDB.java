...
@MessageDriven(name="clienteHomeBroker.ConsumidorHomeBrokerMSMDB",activationConfig=
{
	    ...
	    @ActivationConfigProperty(propertyName="messageSelector",propertyValue="Microsoft = TRUE")
	    
	    

}
		)
public class ConsumidorHomeBrokerMSMDB implements MessageListener{
	...
	public void onMessage(Message mensagem) {
			...
			try {
				...
				ConsumidorHomeBrokerMSMDB asyncReceiver = new ConsumidorHomeBrokerMSMDB();
